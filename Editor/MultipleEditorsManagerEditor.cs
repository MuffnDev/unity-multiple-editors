...
namespace MuffinDev.MultipleEditors
{
	...
	public class MultipleEditorsManagerEditor : TEditor<MultipleEditorsManager>
	{
        ...
        [SerializeField]
        private VoidEvent m_RequiresRepaintEvent = new VoidEvent();
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Draw filter field
            m_Filter = EditorHelpers.SearchBar
            (
                m_Filter,
                new GUIStyle("SearchTextField").Margin(SETTINGS_BLOCK_SMALL_MARGIN, 0, 0, 0),
                new GUIStyle("SearchCancelButton").Margin(0, SETTINGS_BLOCK_SMALL_MARGIN, 0, 0),
        ...
        /// Called when the help block animation is playing.
        /// </summary>
        public VoidEvent OnRequiresRepaint
        {
